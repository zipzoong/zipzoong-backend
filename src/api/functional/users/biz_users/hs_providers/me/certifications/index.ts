 ...
 * @module api.functional.users.biz_users.hs_providers.me.certifications
 ...
 * 
 * @controller UsersHSProvidersMeCertificationsController.getList()
 * @path GET /users/biz-users/hs-providers/me/certifications
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace getList {
    ...
    export const PATH: string = "/users/biz-users/hs-providers/me/certifications";
    ...
    export const path = (): string => {
        return `/users/biz-users/hs-providers/me/certifications`;
    }
 ...
 * 
 * @controller UsersHSProvidersMeCertificationsController.create()
 * @path POST /users/biz-users/hs-providers/me/certifications
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
